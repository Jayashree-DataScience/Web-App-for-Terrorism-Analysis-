# -*- coding: utf-8 -*-
"""
Created on Sat Apr  3 19:48:55 2021
...
def create_app_ui():
    ...
    main_layout=html.Div([
                    html.H1("Terrorism Analysis with Insights",id='main_title',style={'textAlign':'center','color':'red','backgroundColor':'black'}),
                    html.Br(),
                    html.Img(id='banner',src=app.get_asset_url('banner.jpeg'),style={'height':'10%','width':'20%'}),
                    dcc.Tabs(id="Tabs",value="Map",parent_style=tab_style, style=tab_selected_style,colors={
                             "border": "red","primary": "green", "background": "orange"},children=[
                        
                        dcc.Tab(label="Map Tool",id="Map Tool",value="Map",children=[
                          dcc.Tabs(id="subtabs",value="WorldMap",children=[
                              dcc.Tab(label="WorldMap",id="World",value="WorldMap"),
                              dcc.Tab(label="IndiaMap",id="India",value="IndiaMap")
                                  ])  ,
            ...
            dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
                dcc.Tab(label="World Chart tool", id="WorldC", value="WorldChart", children = [          
                    ...
                    dcc.RangeSlider(
                      ...
                      value=[min(year_list),max(year_list)],
                     # marks=year_dict,
                     marks={'label' : year_dict, 'style':{'color':'blue'}},
    ...
    dcc.Loading(dcc.Graph(id='graph-object', figure = go.Figure()))
        ...
        ], style={'textAlign': 'center','color':'grey','backgroundColor':'orange'})
    return main_layout
...
def main():
    ...
    project_name="Global Terrorism Analysis with Insights"
    
    app.layout=create_app_ui()
    app.title=project_name
    app.run_server()
    print("This will be printed after closing the file")
    app=None
    project_name=None
